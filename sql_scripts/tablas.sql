CREATE TABLE production ( -- 1
    id                          NUMBER(4)       PRIMARY KEY CONSTRAINT production_id_nn NOT NULL,
...
CREATE TABLE genre ( -- 2
    id                          NUMBER(4)       PRIMARY KEY CONSTRAINT genre_id_nn NOT NULL,
    name                        VARCHAR2(30)    CONSTRAINT genre_name_nn NOT NULL,
    characteristics             VARCHAR2(90)
);

CREATE TABLE genre_by_prod ( -- 3
    id                          NUMBER(4)       PRIMARY KEY CONSTRAINT genreByProd_id_nn NOT NULL,
...
CREATE TABLE price_log ( -- 4
    id                          NUMBER(4)       PRIMARY KEY CONSTRAINT priceLog_id_nn NOT NULL,
...
CREATE TABLE prod_company ( -- 5
    id                          NUMBER(4)       PRIMARY KEY CONSTRAINT prodCompany_id_nn NOT NULL,
    name                        VARCHAR2(30)    CONSTRAINT prodCompany_name_nn NOT NULL,
    id_country                  NUMBER(4)
);

CREATE TABLE prod_by_company ( -- 6
    id                          NUMBER(4)       PRIMARY KEY CONSTRAINT prodByCompany_id_nn NOT NULL,
...
CREATE TABLE platform ( -- 7
    id                          NUMBER(4)       PRIMARY KEY CONSTRAINT platform_id_nn NOT NULL,
    url                         VARCHAR2(60),
    name                        VARCHAR2(30)    CONSTRAINT platform_name_nn NOT NULL
);

CREATE TABLE prod_in_platform ( -- 8
    id                          NUMBER(4)       PRIMARY KEY CONSTRAINT prodInPlatform_id_nn NOT NULL,
...
CREATE TABLE catalog ( -- 10
    id                          NUMBER(4)       PRIMARY KEY CONSTRAINT catalog_id_nn NOT NULL,
    name                        VARCHAR2(30)    CONSTRAINT catalog_name_nn NOT NULL
);

CREATE TABLE series ( -- 11
    id                          NUMBER(4)       PRIMARY KEY CONSTRAINT series_id_nn NOT NULL,
...
CREATE TABLE season ( -- 12
    id                          NUMBER(4)       PRIMARY KEY CONSTRAINT season_id_nn NOT NULL,
...
CREATE TABLE prod_country ( -- 14
    id                          NUMBER(4)       PRIMARY KEY CONSTRAINT prodCountry_id_nn NOT NULL,
...
CREATE TABLE country ( -- 15
    id                          NUMBER(4)       PRIMARY KEY CONSTRAINT country_id_nn NOT NULL,
    name                        VARCHAR2(30)    CONSTRAINT country_name_nn NOT NULL
);

CREATE TABLE province ( -- 16
    id                          NUMBER(4)       PRIMARY KEY CONSTRAINT province_id_nn NOT NULL,
...
CREATE TABLE city ( -- 17
    id                          NUMBER(4)       PRIMARY KEY CONSTRAINT city_id_nn NOT NULL,
...
CREATE TABLE address ( -- 18
    id                          NUMBER(4)       PRIMARY KEY CONSTRAINT address_id_nn NOT NULL,
...
CREATE TABLE address_filmP ( -- 19
    id                          NUMBER(4)       PRIMARY KEY CONSTRAINT addressFilmP_id_nn NOT NULL,
