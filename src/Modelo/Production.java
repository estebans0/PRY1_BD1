...
public class Production {
   ...
   protected ArrayList<Platform>Platforms;
    ...
    public void setTheProductionReviews(java.sql.Connection conn) throws SQLException{
        this.reviewList = new ArrayList<>();
     ...
     */
    private void getAllSales(java.sql.Connection conn) throws SQLException{
        this.priceLog = new ArrayList<>();
